...
impl vstd::std_specs::ops::AddSpecImpl<&ProjectiveNielsPoint> for &EdwardsPoint {
    ...
    open spec fn add_req(self, rhs: &ProjectiveNielsPoint) -> bool {
        ...
        sum_of_limbs_bounded(&self.Y, &self.X, u64::MAX) && fe51_limbs_bounded(&self.X, 54)
            && fe51_limbs_bounded(&self.Y, 54) && fe51_limbs_bounded(&self.Z, 54) && fe51_limbs_bounded(
            &self.T,
            54,
        ) && fe51_limbs_bounded(&rhs.Y_plus_X, 54) && fe51_limbs_bounded(&rhs.Y_minus_X, 54) && fe51_limbs_bounded(
            &rhs.Z,
            54,
    ...
    open spec fn add_req(self, rhs: &AffineNielsPoint) -> bool {
        ...
        sum_of_limbs_bounded(&self.Y, &self.X, u64::MAX) && sum_of_limbs_bounded(
         ...
         && fe51_limbs_bounded(&self.X, 54) && fe51_limbs_bounded(&self.Y, 54) && fe51_limbs_bounded(&self.Z, 54)
            && fe51_limbs_bounded(&self.T, 54) && fe51_limbs_bounded(&rhs.y_plus_x, 54) && fe51_limbs_bounded(
            &rhs.y_minus_x,
            54,
