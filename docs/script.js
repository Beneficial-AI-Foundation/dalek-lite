        ...
        tbody.innerHTML = filteredFunctions.map(func => {
            ...
            return `
                <tr>
                    ...
                    <td><a href="https://beneficial-ai-foundation.github.io/dalek-lite/callgraph/?source=${encodeURIComponent(func.function)}" target="_blank" class="function-link">Graph →</a></td>
                </tr>
            `;
        }).join('');
    }
